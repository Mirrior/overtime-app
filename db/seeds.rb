...
AuditLog.create!(user_id: User.first.id, status: 0, start_date: (Date.today - 13.days))
AuditLog.create!(user_id: User.first.id, status: 0, start_date: (Date.today - 20.days))
